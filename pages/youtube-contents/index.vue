      ...
      <div class="container">
        ...
        <div class="row about-cols" style="max-width: 760px; margin: 0 auto;">
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <a href="https://www.youtube.com/watch?v=Xh9vk32-Bbg" target="_blank">
                  <img src="/img/mission2.png" alt="" class="img-fluid">
                </a>
                <div class="icon">
        ...
        <div class="row about-cols" style="max-width: 760px; margin: 0 auto;">
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <a href="https://www.youtube.com/watch?v=f-7LF2XZNxk" target="_blank">
                  <img src="/img/mission3.png" alt="" class="img-fluid">
                </a>
                <div class="icon">
                  <i class="ion-ios-speedometer-outline" />
                </div>
            ...
            <div class="about-col">
              <div class="img">
                <a href="https://www.youtube.com/watch?v=-kqmTFCrPtE" target="_blank">
                  <img src="/img/mission1.png" alt="" class="img-fluid">
                </a>
                <div class="icon">
                  <i class="ion-ios-speedometer-outline" />
                </div>
