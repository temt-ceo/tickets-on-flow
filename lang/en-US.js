export default {
  ...
  special_subtitle1: "Before the market opens at 9:30, we use various data to predict how zm's stock price will move on the day. I was one of the people who got hooked on zm's stock price in 2020 and decided to get the data due to the unique nature of the day's movements. I have over 7 AI certifications, so it was perfect data to do a pattern analysis on the AI model. I used it to create a model that predicted 6 patterns and 8 levels each of what price I should buy at and what price I should sell at exactly. This AI model is designed to repeat selling and buying at least once a day. Wouldn't it be nice to know how the stock price will move? Have you ever wanted to compete on the same playing field as the retail sector of a bank? This ticket will make your wish come true.",
